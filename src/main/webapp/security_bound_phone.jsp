...
<script type="text/javascript">
	...
	$(":submit").click(function() {
		if (payPasswordOK == 0 || linkManPhoneOK == 0) {
			alert("信息填写不完整或不正确");
			return false;
		} else {
			return true;
...
<body>
	...
	<div id="header">
		<div class="layout">
			<div id="logo">
				<a href="uc.html"> <img src="images/logo.png" alt="蓝桥" />
				</a>
			</div>
		...
		<div class="col-menu">
			<ul class="menu-items">
				<li><a class="menu-txt iconfont icon-menu-um"
					href="member_information.html">会员资料</a></li>
			...
			<div class="main-bd">
				...
				<form class="form-bd" action="" id="demoForm">
					<div class="form-item">
						...
						<div class="form-entity">
							<div class="form-field">
								<input class="ipt" id="payPassword" name="payPassword"
									placeholder="密码只能是6位数字"
							...
							<div class="form-field">
								<div class="form-twin-group">
									<input class="ipt ipt-code" type="text" id="number"
										...
										<input class="ipt ipt-code" type="hidden" id="number2"
					...
					<div class="form-action clearfix">
						<a href="${applicationScope.url}/enterpriseUser/modifyPhone" class="glb-btn submit-btn"
							type="submit"> <span>提 交</span>
						</a>
					</div>
				</form>
			</div>
