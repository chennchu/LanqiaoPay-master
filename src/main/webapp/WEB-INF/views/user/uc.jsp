		...
		$(function(){
         ...
         $("#address").text(str);   
				...
				$("#transfer").click(function() {
					...
					window.open("BankController/toTransfer")
				});
				...
				<div class="uc-main-box clearfix">
						...
						<div class="uc-acc-box">
							<div class="uc-acc-bd">
								...
								<div class="uc-acc-main">
									...
									<a class="item-link" href="${applicationScope.url}/userController/userTradeHistory?id=${sessionScope.user.id}">查看明细</a>
								</div>
					...
					<div class="uc-col-side uc-col-security">
						<div class="side-hd">
							...
							if(zf!=null&&email==null){
							%><p class="level-ico level-ico-2"></p>
							<%
							} else if(zf!=null&&email!=null){
						...
						<div class="side-bd">
							<ul class="uc-col-items">
								<li>
									...
									<a class="item-act" href="secretController/skipUpdatePayPwd">修改</a>
									<%
									}else{
									%>
									<span class="item-txt">未设置支付密码</span>
									<a class="item-act" href="secretController/skipUpdatePayPwd">设置</a>
									<%
									}
									 %>							
								</li>
								<li>
									...
									<a class="item-act" href="userController/toUpdate">修改</a>
									<%
									}else{
									%>
									<span class="item-txt">未绑定邮箱</span>
									<a class="item-act" href="userController/toUpdate">绑定</a>
									<%
									}
									 %>										
								</li>
								<li>
									...
									<a class="item-act" href="secretController/safe_secret">修改</a>
									<%
									}else{
									%>
									<span class="item-txt">未设置密保问题</span>
									<a class="item-act" href="secretController/safe_secret">设置</a>
									<%
									}
									 %>									
								</li>
