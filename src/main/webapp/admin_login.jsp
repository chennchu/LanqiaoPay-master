...
<meta name="keywords" content="scclui">
<meta name="description" content="scclui">
<title>管理员登录</title>
...
<style type="text/css">
body {
	background: url(resources/sccl-admin/common/image/1.jpg)
...
<body>
	<div class="login-box">
		<header>
		<h1>LanqiaoPay后台管理系统</h1>
		</header>
		<div class="login-main">
			<form action="adminController/loginAdmin" class="layui-form" method="post">
